...
class SaleOrder(models.Model):
    ...
    def _create_invoices(self, grouped=False, final=False, date=None):
        ...
        # for index, invoice_vals in enumerate(invoice_vals_list):
        #     invoice_vals['type'] = 'out_invoice'
        for index, invoice in enumerate(invoice_vals_list):
            invoice_vals_list[index]['invoice_date'] = self.date_order
...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _create_invoice(self, order, so_line, amount):
        ...
        invoice_vals['invoice_date'] = order.date_order
